        ...
        <div class="col-md-8">
            ...
            <div class="foto-detail">
                ...
                <form action="{{ route('like.toggle') }}" method="POST">
                    ...
                    <button type="submit"
                        class="btn {{ $foto->likes->contains('user_id', auth()->id()) ? 'btn-success' : 'btn-outline-success' }}">
            ...
            <form action="{{ route('komentar.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="isi_komentar" class="form-control" rows="3" placeholder="Tambahkan komentar..."
                        required></textarea>
